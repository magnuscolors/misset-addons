...
class IndeellijstListReport(ReportXlsx):
    ...
    def generate_xlsx_report(self, workbook, data, orderLines):
        ...
        def _form_data(sol):
            ...
            sline.append(sol.material_status)
            return sline
        ...
        row += 1
        sheet.write(row, 0, 'DTP deadline', bold_format)
        sheet.write(row, 1, adv_issue.dtp_deadline, cell_format)
...
IndeellijstListReport('report.report_indeellijst_list2.xlsx', 'sale.order.line')